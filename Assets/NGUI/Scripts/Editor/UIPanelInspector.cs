...
public class UIPanelInspector : UIRectEditor
{
	...
	protected override bool ShouldDrawProperties ()
	{
		...
		{
			/********** ZYNGA MODIFIED **********/
			// moved code in this block to it's own function so we could override in innerpanel
			this.DrawDepth(mPanel);
			/*********** END ZYNGA MODIFIED *******/
		}
	...
	/*************** ZYNGA ADDED *********************/
	// Moved depth into it's own function so we could override it for InnerPanel
	// See the Zynga Removed in the above function for where this code was taken
	protected virtual void DrawDepth(UIPanel panelToUpdate)
	{
