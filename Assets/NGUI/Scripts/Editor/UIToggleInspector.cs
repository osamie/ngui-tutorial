...
public class UIToggleInspector : UIWidgetContainerEditor
{
	...
	public override void OnInspectorGUI ()
	{
		...
		/******************* ZYNGA ADDED! *******************/
		// Added option to setup the inspector UI to change the optionCanBeNone, 
		// this allows Toggles to behave as Toggle switches rather than radio buttons
		NGUIEditorTools.SetLabelWidth(110f);
		NGUIEditorTools.DrawProperty("Option can Toggle", serializedObject, "optionCanBeNone");
		/******************* END ZYNGA ADDED! *******************/
