...
public class UISprite : UIBasicSprite
{
    ...
    protected void MirroredFill (BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
    {
        ...
        //width is z, height is w
        Vector4 v = drawingDimensions;
        
        float halfWidth = (v.z - v.x) / 2.0f;
        
        //render the left half
        verts.Add(new Vector3(v.x, v.y));
        verts.Add(new Vector3(v.x, v.w));
        verts.Add(new Vector3(v.x + halfWidth, v.w));
        verts.Add(new Vector3(v.x + halfWidth, v.y));
        ...
        //render the right half
        verts.Add(new Vector3(v.x + halfWidth, v.y));
        verts.Add(new Vector3(v.x + halfWidth, v.w));
        verts.Add(new Vector3(v.z, v.w));
        verts.Add(new Vector3(v.z, v.y));
        Vector2 uv2 = new Vector2(mOuterUV.xMax, mOuterUV.yMin);
        Vector2 uv3 = new Vector2(mOuterUV.xMin, mOuterUV.yMax);
        uvs.Add(uv2);
        uvs.Add(new Vector2(uv2.x, uv3.y));
        uvs.Add(uv3);
        uvs.Add(new Vector2(uv3.x, uv2.y));
        cols.Add(col);
        cols.Add(col);
        cols.Add(col);
        cols.Add(col);
