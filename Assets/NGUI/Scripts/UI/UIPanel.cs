...
public class UIPanel : UIRect
{
	...
	/// </summary>
	/****************** ZYNGA MODIFIED **************/
	// Made this virtual so it could be overridden in InnerPanel.cs
...
/********* ZYNGA MODIFIED **************/
    public static Dictionary<Transform,UIPanel> QuickLookup = new Dictionary<Transform,UIPanel>();
...
/********* END ZYNGA MODIFIED **************/
		...
		mHalfPixelOffset = (Application.platform == RuntimePlatform.WindowsPlayer ||
            ...
            /**** ZYNGA MODIFIED ****
             * Web player deprecated with Unity 5.4
             *
