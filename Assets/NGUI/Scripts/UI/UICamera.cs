...
public class UICamera : MonoBehaviour
{
	...
	public class MouseOrTouch
	{
		...
		/*********** ZYNGA ADDED ***********/
		public Vector2 largestDelta;	// Biggest delta since the event started being tracked
		/*********** END ZYNGA ADDED *******/
...
/**** ZYNGA MODIFIED ****
 * WP8 deprecated with Unity 5.4.3
...
**** END ZYNGA MODIFIED ****/
	...
	void ProcessPress (bool pressed, float click, float drag)
	{
		...
		if (pressed)
		{
			...
			/*********** ZYNGA ADDED ***********/
			currentTouch.largestDelta = Vector2.zero;
			/*********** END ZYNGA ADDED *******/
		...
		else if (currentTouch.pressed != null && (currentTouch.delta.sqrMagnitude != 0f || currentTouch.current != currentTouch.last))
		{
			...
			/*********** ZYNGA ADDED ***********/
			if(currentTouch.totalDelta.sqrMagnitude > currentTouch.largestDelta.sqrMagnitude)
			{
				currentTouch.largestDelta = currentTouch.totalDelta;
			}
			/*********** END ZYNGA ADDED *******/
