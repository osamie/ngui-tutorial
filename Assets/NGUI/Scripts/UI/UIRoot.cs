...
public class UIRoot : MonoBehaviour
{
	...
	protected virtual void OnEnable ()
    {
        ...
        // Restricting resolution to 1990 X 1440 for all higher resolution windows devices
        #if UNITY_METRO
        if (Screen.height > 1990 || Screen.width > 1990)
        {
            Screen.SetResolution(1990, 1440, true);
        }
        #endif
	...
	public int activeHeight
	{
		...
		{
			/*** ZYNGA ADDED MODIFIED ***/
			#if (UNITY_IOS || UNITY_ANDROID || UNITY_WINRT || UNITY_BLACKBERRY) && !UNITY_EDITOR
	...
	public float GetPixelSizeAdjustment (int height)
	{
		...
		if (activeScaling == Scaling.ConstrainedOnMobiles)
