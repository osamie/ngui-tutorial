...
public class UIEventTrigger : MonoBehaviour
{
	...
	/******************* ZYNGA ADDED! *******************/
	public List<EventDelegate> onReleaseInside = new List<EventDelegate>();
	/******************* END ZYNGA ADDED! *******************/
	...
	void OnPress (bool pressed)
	{
		...
		/******************* ZYNGA ADDED! *******************/
		if(!pressed && UICamera.currentTouch != null && UICamera.currentTouch.current == this.gameObject)
		{
			EventDelegate.Execute(onReleaseInside);
		}
		/******************* END ZYNGA ADDED! *******************/
		current = null;
	}
