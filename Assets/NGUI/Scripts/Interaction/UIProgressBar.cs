...
public class UIProgressBar : UIWidgetContainer
{
	...
	public virtual void ForceUpdate ()
	{
		...
		{
			/*** ZYNGA MODIFIED!  Moved logic into GetPositionAtValue ***/
			SetThumbPosition(this.GetPositionAtValue(value));
			/*** END ZYNGA MODIFIED ***/
		}
	...
	/*** ZYNGA MODIFIED!  Moved this logic out of ForceUpdate ***/
	public Vector3 GetPositionAtValue(float value)
	{
		...
		if (isHorizontal)
		{
			...
			return Vector3.Lerp(v0, v1, isInverted ? 1f - value : value);
		}
		else
		{
