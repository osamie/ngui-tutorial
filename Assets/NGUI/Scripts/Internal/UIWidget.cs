	...
	public void CheckLayer ()
	{
		if (panel != null && panel.gameObject.layer != gameObject.layer)
		{
			...
			//Debug.LogWarning("You can't place widgets on a layer different than the UIPanel that manages them.\n" +
			 Debug.LogWarning("You can't place widgets on a layer(" + gameObject.layer + ") different than the UIPanel " + panel.gameObject.name + "(" + panel.gameObject.layer + ") that manages them.\n" +
...
/********* ZYNGA MODIFIED **************/
    public static Dictionary<Transform, UIWidget> QuickLookup = new Dictionary<Transform, UIWidget>();
...
/********* END ZYNGA MODIFIED **************/
	...
	{
#if UNITY_EDITOR
		if (!Application.isPlaying && GetComponents<UIWidget>().Length > 1)
		{
